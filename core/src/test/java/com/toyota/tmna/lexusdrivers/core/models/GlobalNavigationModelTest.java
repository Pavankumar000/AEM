...
class GlobalNavigationModelTest {
    ...
    //     String actual = globalNavigationModel.getLogoalt();
    //     assertEquals(expected, actual);
    // }
    ...
    @Test
    void getBottomText() {
        String expected = "Add this vehicle to your account by <a href=\\\"/lexusdrivers/account/login.login.html\\\" target=\\\"_self\\\">SIGNING IN</a> or <a href=\\\"/lexusdrivers/account/register\\\">CREATING AN ACCOUNT</a>.";
    ...
    //====
    @Test
    void  getBenefitsTitle() {
    	String expected = "benefitsTitle";
        String actual = globalNavigationModel.getBenefitsTitle();
        assertEquals(expected, actual);
	}

    @Test
    void  getManageGarageName() {
    	String expected = "manageGarageName";
        String actual = globalNavigationModel.getManageGarageName();
        assertEquals(expected, actual);

	}

    @Test
    void  getManageGarageValue() {
    	String expected = "manageGarageValue";
        String actual = globalNavigationModel.getManageGarageValue();
        assertEquals(expected, actual);
    ...
    void  getLinktype() {
        ...
        String actual = globalNavigationModel.getLinktype();
        assertEquals(expected, actual);

	}

    @Test
    void  getSectionLabel() {
    	String expected = "sectionLabel";
        String actual = globalNavigationModel.getSectionLabel();
        assertEquals(expected, actual);

	}

    @Test
    void  getVehicleSelectText() {
    	String expected = "vehicleSelectText";
        String actual = globalNavigationModel.getVehicleSelectText();
        assertEquals(expected, actual);

	}

    @Test
    void  getVehicleYearSelector() {
    	String expected = "vehicleYearSelector";
        String actual = globalNavigationModel.getVehicleYearSelector();
        assertEquals(expected, actual);
    ...
    @Test
    void   getClearFormLabel() {
    	String expected = "clearFormLabel";
        String actual = globalNavigationModel.getClearFormLabel();
        assertEquals(expected, actual);

	}
	
    @Test
    void   getSectionDescription() {
    	String expected = "sectionDescription";
        String actual = globalNavigationModel.getSectionDescription();
        assertEquals(expected, actual);
    ...
    @Test
    void   getManageGarageIcon() {
    	String expected = "manageGarageIcon";
        String actual = globalNavigationModel.getManageGarageIcon();
        assertEquals(expected, actual);
    ...
    void getTiles() {
        ...
        globalNavigationModel = context.request().adaptTo(GlobalNavigationModel.class);
        assert globalNavigationModel != null;
        Resource actual = globalNavigationModel.getTiles();
        assertNotNull(actual);
        assertEquals("/content/tiles", actual.getPath());
        assert expected != null;
        assertEquals(expected.getValueMap().toString(), actual.getValueMap().toString());
    }
    ...
    void getExportedType() {
        String object = globalNavigationModel.getExportedType();
    ...
    void getDefaultImg() {
        ...
        String actual = globalNavigationModel.getDefaultImg();
        assertEquals(expected, actual);
    }
