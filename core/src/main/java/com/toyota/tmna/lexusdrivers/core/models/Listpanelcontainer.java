...
/**
 * Defines the {@code Listpanelcontainer} Sling Model used for the {@code lexusdrivers/components/content/listpanelcontainer} component.
 * 
 */
@ConsumerType
public interface Listpanelcontainer
