...
/**
 * Defines the {@code Exploredrivers} Sling Model used for the {@code lexusdrivers/components/content/exploredrivers} component.
 * 
 */
@ConsumerType
public interface Exploredrivers
