...
/**
 * Defines the {@code Vehicleservicehistoryview} Sling Model used for the {@code lexusdrivers/components/content/vehicleservicehistoryview} component.
 * 
 */
@ConsumerType
public interface Vehicleservicehistoryview
