...
/**
 * Defines the {@code Multiselectfilter} Sling Model used for the {@code lexusdrivers/components/content/multiselectfilter} component.
 * 
 */
@ConsumerType
public interface Multiselectfilter
