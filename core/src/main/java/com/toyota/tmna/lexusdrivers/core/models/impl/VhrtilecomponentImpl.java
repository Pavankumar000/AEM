...
import com.toyota.tmna.lexusdrivers.core.models.Vhrtilecomponent;
...
@Model(adaptables = {
    ...
    VhrtilecomponentImpl.class,
    ComponentExporter.class
}, resourceType = "lexusdrivers/components/content/vhrtilecomponent")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class VhrtilecomponentImpl
    implements Vhrtilecomponent
{
