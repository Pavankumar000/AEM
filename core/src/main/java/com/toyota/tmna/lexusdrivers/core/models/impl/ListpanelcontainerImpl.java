...
import com.toyota.tmna.lexusdrivers.core.models.Listpanelcontainer;
...
@Model(adaptables = {
    SlingHttpServletRequest.class
        ...
        ListpanelcontainerImpl.class,
    ComponentExporter.class
}, resourceType = "lexusdrivers/components/content/listpanelcontainer")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class ListpanelcontainerImpl
    implements Listpanelcontainer
{
