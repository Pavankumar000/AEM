...
/**
 * Defines the {@code Enformpageview} Sling Model used for the {@code lexusdrivers/components/content/enformpageview} component.
 * 
 */
@ConsumerType
public interface Enformpageview
