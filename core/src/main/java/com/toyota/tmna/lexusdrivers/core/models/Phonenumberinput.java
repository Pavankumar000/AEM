...
/**
 * Defines the {@code Phonenumberinput} Sling Model used for the {@code lexusdrivers/components/content/phonenumberinput} component.
 * 
 */
@ConsumerType
public interface Phonenumberinput
